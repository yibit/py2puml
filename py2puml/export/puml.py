...
"""
PUML_FILE_FOOTER = """footer Generated by //{author}// with py2puml
"""
...
def to_puml_content(diagram_name: str, theme:str, author: str, uml_items: List[UmlItem], uml_relations: List[UmlRelation]) -> Iterable[str]:
    yield PUML_FILE_START.format(diagram_name=diagram_name, theme=theme)
    ...
    yield PUML_FILE_FOOTER.format(author=author)
    yield PUML_FILE_END
