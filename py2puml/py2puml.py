...
def py2puml(domain_path: str, domain_module: str, theme: str, author: str) -> Iterable[str]:
    domain_items_by_fqn: Dict[str, UmlItem] = {}
    domain_relations: List[UmlRelation] = []
    inspect_package(domain_path, domain_module, domain_items_by_fqn, domain_relations)

    return to_puml_content(domain_module, theme, author,domain_items_by_fqn.values(), domain_relations)
